        ...
        <div class="sm:flex sm:items-center sm:justify-between mb-8">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    {{ __('Manage messages from your portfolio contact form.') }}
                </p>
            </div>
        </div>
            ...
            <div class="p-6">
                ...
                @else
                    <div class="text-center py-8">
                        ...
                        <h3 class="mt-2 text-lg font-medium text-gray-900 dark:text-white">{{ __('No messages found') }}</h3>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('You haven\'t received any contact messages yet.') }}</p>
                    </div>
                @endif
            </div>
        </div>
